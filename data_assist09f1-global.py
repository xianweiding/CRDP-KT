                ...
                for qa in QA:
                    if qa[1]!=q[1]:
                        if qa[1]==1 and abs(qa[2]-q[2])>=0.8 and qa[2]>q[2] and qa[3]==q[3]:
                            if Q.index(q)-QA.index(qa)!=0:
                                L=Q.index(q)-QA.index(qa)
                            else:
                                L=1
                            skn=0
                            c1=0
                            c2=0
                            QL=Q[QA.index(qa):Q.index(q)]
                            for ql in QL:
                                c2=c2+ql[1]
                                if qa[3]==ql[3]:
                                    c1=c1+ql[1]
                            ...
                            if yes>=0.7:
                                ...
                                QA[QA.index(qa)][1] = 1
                                #print('滑倒')
                        elif qa[1] == 0 and Q.index(q) - QA.index(qa) >= 7 and qa[3] == q[3]:
                            L = Q.index(q) - QA.index(qa)
                            skn = 0
                            c1 = 0
                            c2 = 0
                            ...
                            if yes > 2.124:
                                ...
                                QA[QA.index(qa)][1] = 1
                                print('正确连续性')
                        elif qa[1] == 1 and Q.index(q) - QA.index(qa) >= 7 and qa[3] == q[3]:
                            L = Q.index(q) - QA.index(qa)
                            skn = 0
                            c1 = 0
                            c2 = 0
...
if __name__ == '__main__':
    ...
    # DP.pro_skill_graph()
    # DP.pro_skill_graph1()
    DP.generate_user_sequence('dataf1-1-2.txt')
